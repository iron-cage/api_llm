...
GWT spec scenarios for all `api_huggingface` doc entity instances. Each subdirectory mirrors a `docs/` entity; each spec file mirrors one doc instance.

## Responsibility Table

| Path | Purpose |
|------|---------|
| `api/` | AP- scenarios mirroring `docs/api/` instances |
