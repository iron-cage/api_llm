...
Spec scenarios for `docs/collection/001_features.md`. Verifies that the Cargo feature flag catalog is complete, correctly classified, and consistent with `Cargo.toml`.

### CL-01: integration feature exists in the catalog

- **Given:** `docs/collection/001_features.md` Testing Features table
...
- **Given:** `docs/collection/001_features.md` Convenience Bundles table
...
- **Given:** `docs/collection/001_features.md` Tier 1 Core API Features table
