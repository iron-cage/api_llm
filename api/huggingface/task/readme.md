...
|-------|----|-------------|-------|----------|--------|----------|-------|----------|-----|------|---------|
| 1 | [001](verified/001_consolidate_duplicate_chat_types.md) | 588 | 7 | 6 | 7 | 2 | 🎯 (Verified) | ai | `src/` | [Consolidate duplicate chat types](verified/001_consolidate_duplicate_chat_types.md) | Remove duplicate ChatCompletionRequest/ChatMessage/ChatChoice/Usage defs from providers.rs |
...
| 3 | [004](verified/004_replace_wiremock_with_real_api.md) | 420 | 6 | 5 | 7 | 2 | 🎯 (Verified) | ai | `tests/` | [Replace wiremock with real API calls](verified/004_replace_wiremock_with_real_api.md) | Replace wiremock in health_check_tests.rs with real integration tests |
