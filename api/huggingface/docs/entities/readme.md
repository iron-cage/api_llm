...
| `collection/` | [readme.md](../collection/readme.md) | Enumerated item catalogs — feature flag tables, tier classifications | 1 |
...
| 001 | collection | Features | [collection/001_features.md](../collection/001_features.md) | ✅ |
