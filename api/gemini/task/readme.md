...
| 001 | [Migrate spec.md to docs/ entity instances](completed/001_migrate_spec_to_docs.md) | ✅ (Completed) | 5 | 1440 | `docs/` |
| 003 | [Fix circuit breaker per-call state reset](verified/003_fix_circuit_breaker_per_call_reset.md) | 🎯 | 4 | 1120 | `src/internal/http/` |
| 006 | [Migrate execute_legacy callers to execute_with_optional_retries](completed/006_migrate_execute_legacy_callers.md) | ✅ (Completed) | 3 | 1008 | `src/client/api_interfaces/` |
...
| 009 | [Bring api_gemini Test Suite into Compliance with Testing Standards Invariant](unverified/009_bring_tests_into_invariant_compliance.md) | ❓ | 2 | 450 | . |
