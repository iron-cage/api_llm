...
- **Purpose**: Document non-negotiable behavioral constraints governing every implementation decision in `api_openai_compatible`.
...
- **Out of Scope**: Feature-specific behaviors (see `feature/`), API contracts (see `api/`), implementation patterns.
